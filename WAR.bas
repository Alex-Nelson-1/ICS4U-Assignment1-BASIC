...
210 PRINT
220 PRINT
230 DIM A$(52), L(52) ' Corrected size from L(54) to L(52)
240 FOR I = 1 TO 52
250 READ A$(I)
260 NEXT I
270 RANDOMIZE ' Use RANDOMIZE instead of RANDOM
280 FOR J = 1 TO 52
290 LET L(J) = INT(52 * RND + 1)
300 FOR K = 1 TO J
...
430 LET N1 = INT((M1 - 53) / 4)
440 LET N2 = INT((M2 - 53) / 4)
450 IF N1 >= N2 THEN 490
460 LET A1 = A1 + 1
470 PRINT "COMPUTER WINS. YOU HAVE "; B1; "; COMPUTER HAS "; A1
480 GOTO 540
...
610 PRINT
620 PRINT
630 PRINT "YOU HAVE RUN OUT OF CARDS. FINAL SCORE: YOU -- "; B1; "; COMPUTER -- "; A1
